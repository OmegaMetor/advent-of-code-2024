...
pub fn part_one(input: &str) -> Option<u32> {
    ...
    input.lines().for_each(|line| reports.push(
        line.split_whitespace().map(|number| number.parse::<u32>().unwrap()).collect::<Vec<u32>>()));
    ...
    'reports: for mut report in reports {
        ...
        for i in 1..report.len() {
            if report[i-1] > report[i] { // If decreasing
                continue 'reports
            }
...
pub fn part_two(input: &str) -> Option<u32> {
    ...
    for mut report in reports {
        ...
        for i in 1..report.len() {
            ...
            if previous_value > current_value { // If decreasing
                problems += 1;
                continue
            }
